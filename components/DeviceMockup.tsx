...
export default function DeviceMockup({
  ...
  return (
    <div className="relative mx-auto mt-16 mb-8 w-full max-w-4xl px-4 pb-10">
      ...
      <div className="absolute right-0 bottom-0 z-20 w-44 rotate-6 rounded-xl border-[5px] border-zinc-800 bg-zinc-900 p-1.5 shadow-2xl transition-transform duration-300 hover:rotate-0 sm:w-64">
